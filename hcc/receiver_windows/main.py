"""
Heavy Control Center — Receiver (Windows Version)
...
app = FastAPI(title="Heavy Control Center — Receiver (Windows)", version="1.0.0")
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "heavy-receiver", "platform": "windows"}
